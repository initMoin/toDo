...
struct WidgetToDoService {
   ...
   func complete(toDoID: String, cloudID: UUID?) throws {
      ...
      try enqueueCompletion(
         toDoID: toDoID,
         cloudID: cloudID,
         ownerUserID: currentSnapshot.ownerUserID
      )
   ...
   private func enqueueCompletion(toDoID: String, cloudID: UUID?, ownerUserID: UUID?) throws {
      ...
      requests.append(ToDoWidgetCompletionRequest(
         toDoID: toDoID,
         cloudID: cloudID,
         ownerUserID: ownerUserID
      ))

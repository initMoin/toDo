   ...
   var body: some View {
      VStack(alignment: .leading, spacing: 10) {
         Text("toDō Sync")
            ...
            .disabled(authStore.isAuthenticating || normalizedUsername == nil)
            .accessibilityHint("Enter a valid username above before signing in with Apple.")
            ...
            .buttonStyle(.plain)
            .disabled(authStore.isAuthenticating || normalizedUsername == nil)
            .accessibilityHint("Enter a valid username above before signing in with Google.")
